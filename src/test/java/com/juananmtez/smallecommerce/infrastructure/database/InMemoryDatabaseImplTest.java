package com.juananmtez.smallecommerce.infrastructure.database;
...
import com.juananmtez.smallecommerce.infrastructure.repository.database.InMemoryDatabaseImpl;
...
public class InMemoryDatabaseImplTest {
    ...
    void saveCart_Success() {
        ...
        assertEquals(
                cartEntityNew.getProducts().get(0).getId(), cartDb.getProducts().get(0).getId());
        assertEquals(
                cartEntityNew.getProducts().get(0).getDescription(),
                cartDb.getProducts().get(0).getDescription());
        assertEquals(
                cartEntityNew.getProducts().get(0).getAmount(),
                cartDb.getProducts().get(0).getAmount());
    }
    ...
    void updateCartEntity_Success() {
        ...
        assertEquals(
                ...
                cartDb.getProducts().get(0).getDescription());
        assertEquals(
                cartEntity.getProducts().get(0).getAmount(),
                cartDb.getProducts().get(0).getAmount());
    }
    ...
    void updateCartEntity_Throws_NotFound() {
        ...
        CartNotFoundException exception =
                assertThrows(
                        CartNotFoundException.class,
                        () -> inMemoryDatabase.updateCartEntity(cartEntityNew));
