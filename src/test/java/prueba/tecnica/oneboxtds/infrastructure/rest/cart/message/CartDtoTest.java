...
public class CartDtoTest {
  ...
  public void cartDtoConstructorWithSpecificParameters() {
    ...
    ProductDto product1 = new ProductDto(UUID.randomUUID(), "Product 1", new BigDecimal("10.0"));
    ProductDto product2 = new ProductDto(UUID.randomUUID(), "Product 2", new BigDecimal("10.0"));
